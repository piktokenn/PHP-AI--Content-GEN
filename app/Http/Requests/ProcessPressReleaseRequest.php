...
class ProcessPressReleaseRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'company' => ['required', 'string', 'max:128', new ValidateBadWordsRule()],
            'description' => ['required', 'string', 'max:1024', new ValidateBadWordsRule()],
            'subject' => ['required', 'string', 'max:512', new ValidateBadWordsRule()],
