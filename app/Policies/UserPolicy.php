...
class UserPolicy
{
    ...
    /**
     * Determine whether the user can use the Templates.
     *
     * @param ?User $user
     * @return bool
     */
    ...
    {
        return $user->plan->features->templates;
    }

    /**
     * Determine whether the user can use the Custom Templates.
     *
     * @param ?User $user
     * @return bool
     */
    public function customTemplates(?User $user)
    {
        return $user->plan->features->custom_templates;
    }
