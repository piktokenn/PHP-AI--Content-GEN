@php
    $parameters = [
        [
            ...
            'type' => 0,
            'format' => 'integer',
            'description' => __('Filter by template ID.') . ' ' . __('Possible values are: :values.', [
                'values' => implode(', ', array_map(function ($item) { return __(':value for :name', ['value' => '<code>'. $item['id'] .'</code>', 'name' => '<span class="font-weight-medium">'.__($item['name']).'</span>']); }, $templates->toArray()))
                ]) . ' ' . __('Defaults to: :value.', ['value' => '<code>freestyle</code>'])
        ], [
            'name' => 'favorite',
            'type' => 0,
            'format' => 'boolean',
