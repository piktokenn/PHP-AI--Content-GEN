                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->words == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->words)
                            <span class="text-muted">{{ number_format(Auth::user()->words_month_count, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->words == 1 ? ':number word' : ':number words'), ['number' => number_format($user->plan->features->words, 0, __('.'), __(','))]) }} <span class="text-muted">/ {{ mb_strtolower(__('Month')) }}</span>
                        @endif
                    </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->documents == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->documents)
                            <span class="text-muted">{{ number_format(Auth::user()->documents_month_count, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->documents == 1 ? ':number document' : ':number documents'), ['number' => number_format($user->plan->features->documents, 0, __('.'), __(','))]) }} <span class="text-muted">/ {{ mb_strtolower(__('Month')) }}</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->images == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->images)
                            <span class="text-muted">{{ number_format(Auth::user()->images_month_count, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->images == 1 ? ':number image' : ':number images'), ['number' => number_format($user->plan->features->images, 0, __('.'), __(','))]) }} <span class="text-muted">/ {{ mb_strtolower(__('Month')) }}</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->chats == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->chats)
                            <span class="text-muted">{{ number_format(Auth::user()->chats_month_count, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->chats == 1 ? ':number chat' : ':number chats'), ['number' => number_format($user->plan->features->chats, 0, __('.'), __(','))]) }} <span class="text-muted">/ {{ mb_strtolower(__('Month')) }}</span>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 p-2 d-flex align-items-center">
                    ...
                    <div class="{{ ($user->plan->features->transcriptions == 0 ? 'text-muted' : '') }} {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-3') }}">
                        ...
                        @elseif($user->plan->features->transcriptions)
                            <span class="text-muted">{{ number_format(Auth::user()->transcriptions_month_count, 0, __('.'), __(',')) }} /</span> {{ __(($user->plan->features->transcriptions == 1 ? ':number transcription' : ':number transcriptions'), ['number' => number_format($user->plan->features->transcriptions, 0, __('.'), __(','))]) }} <span class="text-muted">/ {{ mb_strtolower(__('Month')) }}</span>
                        @endif
                    </div>
                </div>
