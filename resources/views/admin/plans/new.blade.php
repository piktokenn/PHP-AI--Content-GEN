    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.plans.new') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[words]" id="i-features-words" class="form-control{{ $errors->has('features.words') ? ' is-invalid' : '' }}" value="{{ old('features.words') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[documents]" id="i-features-documents" class="form-control{{ $errors->has('features.documents') ? ' is-invalid' : '' }}" value="{{ old('features.documents') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[images]" id="i-features-images" class="form-control{{ $errors->has('features.images') ? ' is-invalid' : '' }}" value="{{ old('features.images') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[chats]" id="i-features-chats" class="form-control{{ $errors->has('features.chats') ? ' is-invalid' : '' }}" value="{{ old('features.chats') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="features[transcriptions]" id="i-features-transcriptions" class="form-control{{ $errors->has('features.transcriptions') ? ' is-invalid' : '' }}" value="{{ old('features.transcriptions') }}">
            ...
            <div class="form-group">
                ...
                <select name="features[templates]" id="i-features-templates" class="custom-select{{ $errors->has('features.templates') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if(old('features.templates') == $key) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="features[custom_templates]" id="i-features-custom-templates" class="custom-select{{ $errors->has('features.custom_templates') ? ' is-invalid' : '' }}">
                    @foreach([1 => __('On'), 0 => __('Off')] as $key => $value)
                        <option value="{{ $key }}" @if(old('features.custom_templates') == $key) selected @endif>{{ $value }}</option>
                    @endforeach
                </select>
