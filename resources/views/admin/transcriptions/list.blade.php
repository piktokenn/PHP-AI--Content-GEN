...
<div class="card border-0 shadow-sm">
    <div class="card-header">
        <div class="row">
            <div class="col-12 col-md"><div class="font-weight-medium py-1">{{ __('Transcriptions') }}</div></div>
            <div class="col-12 col-md-auto">
                <form method="GET" action="{{ route('admin.transcriptions') }}" class="d-md-flex">
                            ...
                            <div class="dropdown-menu {{ (__('lang_dir') == 'rtl' ? 'dropdown-menu' : 'dropdown-menu-right') }} border-0 shadow width-64 p-0" id="search-filters">
                                <div class="dropdown-header py-3">
                                    <div class="row">
                                        ...
                                        <div class="col-auto"><a href="{{ route('admin.transcriptions') }}" class="text-secondary">{{ __('Reset') }}</a></div>
                                    </div>
                                </div>
                                ...
                                <div class="row text-truncate">
                                    <div class="col-12 col-lg-6 d-flex align-items-center text-truncate">
                                        <div class="d-flex align-items-center">
                                            <div class="text-truncate">
                                                <a href="{{ route('admin.transcriptions.edit', $transcription->id) }}">{{ $transcription->name }}</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-5 d-flex align-items-center">
                                        <div class="d-inline-block {{ (__('lang_dir') == 'rtl' ? 'ml-3' : 'mr-3') }}">
                                            <img src="{{ gravatar($transcription->user->email, 48) }}" class="rounded-circle width-6 height-6">
                                        </div>
                                        <a href="{{ route('admin.users.edit', $transcription->user->id) }}">{{ $transcription->user->name }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-auto">
